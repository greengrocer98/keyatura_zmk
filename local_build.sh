...
build_mouse () {
    ...
    export ZMK_MODULE_DIRS="${ZMK_ESB_MODULE_DIRS};${NRF_MODULE_DIRS};${NRFXLIB_MODULE_DIRS};${ZMK_BEHAVIOR_ATTR_CYCLE};${ZMK_PAW_3395_DRIVER}"
    west build \
        -p -b nice_nano@2.0.0 \
        -S zmk-usb-logging \
...
build_dongle () {
    ...
    export ZMK_MODULE_DIRS="${ZMK_ESB_MODULE_DIRS};${NRF_MODULE_DIRS};${NRFXLIB_MODULE_DIRS};${ZMK_BEHAVIOR_ATTR_CYCLE}"
    west build \
        -p -b nice_nano@2.0.0 \
        -S studio-rpc-usb-uart \
        -S zmk-usb-logging \
